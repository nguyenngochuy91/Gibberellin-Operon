...
#    cmd13a= "./debias.py -i gene_tree/CYP114/tree/out_tree.nwk -o gene_tree/CYP114/tree/reduce_64.nwk -s 64 -k keep -a accession_to_common.txt"
    ...
    os.system(cmd1)
    stop = time.time()
    print ("Step 1 takes {} secs".format((stop-start)//1000))
#     cmd2
    print ("Executing command: {} \n {} \n".format(cmd2,"  combine contigs given threshold "+str(contigs)))
    start = time.time()
    os.system(cmd2)
    stop = time.time()
    print ("Step 2 takes {} secs".format((stop-start)//1000))
...
#     cmd3
    ...
    os.system(cmd3)
    stop = time.time()
    print ("Step 3 takes {} secs".format((stop-start)//1000))
#     cmd4
    try:
        os.mkdir("db")
    except:
    ...
    os.system(cmd4)
    stop = time.time()
    print ("Step 4 takes {} secs".format((stop-start)//1000))
...
#     cmd5
    ...
    os.system(cmd5)
    stop = time.time()
    print ("Step 5 takes {} secs".format((stop-start)//1000))
    ...
    os.system(cmd6)
    stop = time.time()
    print ("Step 6 takes {} secs".format((stop-start)//1000))
...
#      cmd7 
    ...
    os.system(cmd7)
    stop = time.time()
    print ("Step 7 takes {} secs".format((stop-start)//1000))
#     cmd8
    ...
    for item in cmd8:
        ...
        os.system(item)
    stop = time.time()
    print ("Step 8 takes {} secs".format((stop-start)//1000))
#     cmd9
...
#    cmd12
    ...
    ### boostrap
    print ("Boostraping our trees ... ")
    os.system("./boostrap.py -t new_tree/out_tree.nwk -i new_tree/msa_tmp/distmat_marker.aln -n 100 -o new_tree/boostrap")
    os.system("./boostrap.py -t new_tree/reduce_64.nwk -i new_tree/msa_tmp/distmat_marker.aln -n 100 -o new_tree/bootstrap_rpoB_64")
    os.system("./boostrap.py -t operon_tree/tree/out_tree.nwk -i operon_tree/tree/distmat_marker.aln -n 100 -o operon_tree/tree/bootstrap_120")
    os.system("./boostrap.py -t operon_tree/tree/reduce_64.nwk -i operon_tree/tree/distmat_marker.aln -n 100 -o operon_tree/tree/bootstrap_operon_64")
...
#    os.system(cmd16) 
    ...
    cmd14a = "./ancestral_reconstruction/reconstruction.py -i ancestral_reconstruction/new_result/ -o ancestral_reconstruction/reconstruction_global_rpoB_64 -t new_tree/bootstrap_rpoB_64.nwk -m global -p {}".format(includePseudo)
    print ("Executing command: {} \n {}\n".format(cmd14a," reconstruction using reduce rpoB"))
    os.system(cmd14a)

    cmd15a = "./ancestral_reconstruction/reconstruction.py -i ancestral_reconstruction/new_result/ -o ancestral_reconstruction/reconstruction_global_operon_64 -t operon_tree/tree/bootstrap_operon_64.nwk -m global -p {}".format(includePseudo)
